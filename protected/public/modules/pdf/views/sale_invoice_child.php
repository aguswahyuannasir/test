...
<head>
    <title><?php echo $invoice_child->code . '.pdf'; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
                ...
                <td style="border: 0;  text-align: right" width="62%">
                    <div id="logo" style="font-size:18px">
                        <?php if (isset($template->logo) && $org->image) { ?>
                            <img id="image" src="<?php echo 'http://localhost/test/' . $org->image; ?>" style="max-width:180px" /> <br> <br>
                        <?php } ?>
            ...
            <table id="meta" class="">
                <tr>
                    <td rowspan="5" style="border: 1px solid white; border-right: 1px solid black; text-align: left" width="62%">
                        <?php echo ($data->subject) ? '<h4>' . $data->subject . '</h4><br>' : ''; ?>
