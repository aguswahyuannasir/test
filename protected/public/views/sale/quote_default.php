<div class="container-fluid" style="font-family: Arial, Helvetica, sans-serif;">
    <div class="row mt-2 justify-content-center">
        <div class="col-md-10 d-print-none">
            ...
            <a href="<?php echo base_url('pdf/invoice/quote/' . encode($data->id) . '/' . encode($data->organization) . '/1'); ?>" class="btn btn-primary"><?php echo lang('download_pdf'); ?></a>
        </div>
    </div>
    <div class="row mt-2 justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card border-0 shadow-lg card-content">
                <div class="card-body">
                    ...
                    <table class="border-0" style="clear:both;width:100%;margin-top:10px;table-layout:fixed;" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td valign="top" class="w-print-50 w-25 table-bill" style="vertical-align:top;word-wrap: break-word;line-height: 18px;">
                                    <div style="margin-bottom: 20px;">
                                        ...
                                        <span style="" id="tmp_billing_address">
                                            <div class="pcs-customer-name" id="zb-pdf-customer-detail" style="font-size: 12px !important;">
                                                <?php
                                                ...
                                                echo ($data->customer_company) ? '<div class="" style="font-size:12px;">' . $data->customer_company . '</div>' : '';
                                                echo '<div class="customer-name font-weight-bold" style="font-size:12px;">' . $data->customer_name . '</div>';
                                                echo '<div class="customer-address" style="font-size:12px !important;">' . ($address) . '</div>';
                                                ?>
                                            </div>
                                        </span>
                                ...
                                <td valign="top" class="text-right">
                                    <h4 style="margin-bottom: 0px;"><?php echo "QUOTATION"; ?></h4>
