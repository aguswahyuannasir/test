		...
		<div style="border:1px solid #ccc;width:600px;font-family:arial;font-size:14px;margin:auto;">
			...
			<div style="padding:10px 20px;">
				<table width="100%">
					...
					<tr>
						<td style=""><h4>You have received invitation to becoming a user member <?= $owner_name->fullname; ?>, Click link below to accept invitation</h4></td>
					</tr>
					<tr>
						<td style="text-align: center;">
							<a href="<?= $link ?>" target="_blank" style="font-size: 14px; padding: 6px 12px; margin-bottom: 0; background-color: #2ecc71; border: 1px solid transparent; color: #fff; text-decoration: none;">Accept Invitation</a>
						</td>
					</tr>
				</table>
				<br>
